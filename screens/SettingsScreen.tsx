      ...
      <ScrollView className={`flex-1 ${contentBg} rounded-t-3xl -mt-4`} contentContainerStyle={{ paddingTop: 24, paddingBottom: 40, paddingHorizontal: 24 }}>
        ...
        <View className={`${cardBg} rounded-2xl mb-6`}>
          ...
          <View className="flex-row items-center p-4 border-b border-gray-100">
            ...
            <View className="flex-1">
              <Text className={`text-base font-semibold ${textColor}`}>Push Notifications</Text>
            </View>
            <Switch
          ...
          <View className="flex-row items-center p-4 border-b border-gray-100">
            ...
            <View className="flex-1">
              <Text className={`text-base font-semibold ${textColor}`}>Email Notifications</Text>
            </View>
            <Switch
          ...
          <View className="flex-row items-center p-4">
            ...
            <View className="flex-1">
              <Text className={`text-base font-semibold ${textColor}`}>SMS Notifications</Text>
            </View>
            <Switch
        ...
        <View className={`${cardBg} rounded-2xl mb-6`}>
          ...
          <TouchableOpacity className="flex-row items-center p-4 border-b border-gray-100">
            ...
            <View className="flex-1">
              <Text className={`text-base font-semibold ${textColor}`}>Change Password</Text>
            </View>
          ...
          <TouchableOpacity className="flex-row items-center p-4">
            ...
            <View className="flex-1">
              <Text className={`text-base font-semibold ${textColor}`}>Privacy Settings</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#9CA3AF" />
          </TouchableOpacity>
        </View>
        ...
        <View className={`${cardBg} rounded-2xl`}>
          ...
          <TouchableOpacity className="flex-row items-center p-4 border-b border-gray-100">
            ...
            <View className="flex-1">
              <Text className={`text-base font-semibold ${textColor}`}>Help & Support</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#9CA3AF" />
          </TouchableOpacity>
          ...
          <TouchableOpacity className="flex-row items-center p-4">
            ...
            <View className="flex-1">
              <Text className={`text-base font-semibold ${textColor}`}>Terms & Privacy Policy</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#9CA3AF" />
          </TouchableOpacity>
        </View>
