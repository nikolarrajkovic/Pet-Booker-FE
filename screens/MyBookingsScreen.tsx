          ...
          <View className="flex-row">
            <TouchableOpacity
              ...
              className={`flex-1 py-3 border-b-2 ${
                activeTab === 'upcoming' ? 'border-brand-500' : `border-gray-300 ${isDarkMode ? 'border-gray-700' : ''}`
              }`}
            >
              <Text className={`text-center font-semibold ${
                activeTab === 'upcoming' ? 'text-brand-600' : subtextColor
              }`}>
                Upcoming
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              className={`flex-1 py-3 border-b-2 ${
                activeTab === 'past' ? 'border-brand-500' : `border-gray-300 ${isDarkMode ? 'border-gray-700' : ''}`
              }`}
            >
              <Text className={`text-center font-semibold ${
                activeTab === 'past' ? 'text-brand-600' : subtextColor
              }`}>
                Past Bookings
              </Text>
            </TouchableOpacity>
