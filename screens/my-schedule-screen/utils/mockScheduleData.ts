...
export const mockScheduleData: { [key: string]: ServiceItem[] } = {
  ...
  '2026-04-08': [
    ...
    },
    {
      id: 'u2',
      title: 'Pet Grooming',
      provider: 'Glamour Paws',
      petName: 'Max',
      time: '02:00 PM - 04:00 PM',
      location: 'Glamour Paws Salon',
      type: 'grooming',
      duration: 2,
      isUserService: true,
    },
  ...
  '2026-04-17': [
    {
      ...
      petName: 'Max',
      time: '11:00 AM - 01:00 PM',
      location: 'Downtown Grooming Studio',
      type: 'grooming',
      duration: 2,
      isUserService: true,
    },
