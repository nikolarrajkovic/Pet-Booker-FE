...
| B17 | The inbox sits to the right of the thread, preselects the newest thread and swaps threads in place on web (`MessagesSplitView.test.tsx`); a phone row navigates to `Chat` instead |
